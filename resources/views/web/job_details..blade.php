          ...
          <div class="container">
               <div class="row">
                    <div class="col-lg-3 col-md-3 col-xs-12">
                         <div>
                              ...
                              <img src="images/product-1-720x480.jpg" alt="" class="img-fluid wc-image">
                    ...
                    <div class="col-lg-9 col-md-9 col-xs-12">
                         <form action="#" method="post" class="form">
                              ...
                              <p class="lead"><strong class="text-primary">$6000</strong> <small> per month</small></p>

                              <p class="lead">
                                   <i class="fa fa-briefcase"></i> Computer Jobs &nbsp;&nbsp;
                                   <i class="fa fa-map-marker"></i> Yemen &nbsp;&nbsp;
                                   <i class="fa fa-calendar"></i> 30-01-2022 &nbsp;&nbsp;
               ...
               <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                         <p> Searching for self-motivated individuals who are always looking to achieve the highest standards.</p>
                         ...
                         <p>- MUST have minimum 1 year experience in programming</p>
                         ...
                         <div class="row">
                              <div class="col-md-6">
                                   <p>
                                        ...
                                        <strong><a href="tel:123-456-789">777777777</a></strong>
                                   </p>
                              </div>
                              ...
                              <div class="col-md-6">
                                   <p>
                                        ...
                                        <strong><a href="tel:456789123">777777777</a></strong>
                                   </p>
                              </div>
                         </div>
                         ...
                         <div class="row">
                              <div class="col-md-6">
                                   <p>
                                        ...
                                        <strong><a href="mailto:john@carsales.com">find@jobs.com</a></strong>
                                   </p>
                              </div>
                              ...
                              <div class="col-md-6">
                                   <p>
                                        ...
                                        <strong><a href="#">findjop.com</a></strong>
                                   </p>
                              </div>
                         </div>
