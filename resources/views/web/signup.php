                    ...
                    <div class="col-md-6 col-sm-12">
                         <form id="contact-form" role="form" action="" method="post">
                              <div class="col-md-12 col-sm-12">
                                   ...
                                   <input type="number" class="form-control" placeholder="Enter phone " name="pass" required>
								   
								   
                                   <input type="text" class="form-control" placeholder="Enter city " name="pass" required>

                                    </div>

                              <div class="col-md-4 col-sm-12">
                                   <input type="submit" class="form-control" name="send message" value="log in">
                              </div>
